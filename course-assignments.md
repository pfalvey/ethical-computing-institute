...
## Student Presentation of Ethical Framework (20 Points) <a name="framework-presentation"></a>
### Purpose:
...
+ Your slides must include:
  + A brief introductory slide describing the historical origin of the ethical framework. (3 Points)
  + A slide explaining the connection between the philosopher shown in your framework webpage to the framework. (2 Points)
  + An introduction and discussion of *three* core concepts of the ethical framework. (5 Points)
...
## Website Post 1 (40 Points) <a name="website-post-1">
### Purpose:
...
+ Your statement of purpose (~700 words) must:
  ...
  + A brief summary of three issues in computer technology you believe your ethical framework would have a lot to say about (these do not necessarily have to be topics covered in class). (5 Points)
+ Each of the three codes of ethics responses (~300 words) must:
  + Briefly summarize the similarities between the code of ethics and your ethical framework. (2 Points)
  + Briefly summarize the differences between the code of ethics and your ethical framework. (2 Points)
  + State something that is *missing* from the code of ethics which your ethical framework can provide. (1 Point)
